...
def main():
    ...
    df = get_data_from_postgresql(db_username, db_password, db_host, db_port, db_name, table_name)
    ...
    univ_comparison = get_data_from_postgresql(db_username, db_password, db_host, db_port, db_name, table_name)  
    ...
    * 출처: https://www.journalindicators.com/methodology
    ...
    # 기명/무기명 선택
    anonymity_option = st.radio('기명/무기명 선택', ('기명', '무기명'))
